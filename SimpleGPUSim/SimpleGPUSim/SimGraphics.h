...
class SimGraphics
{
    private:
        ...
        /// <summary>
        /// Texture Frame Buffer on which to render
        /// </summary>
    ...
    public:
        ...
        void Initialize(const XMUINT2& renderTargetSize, uint32_t maxFacesPerIteration, const Camera& camera, uint32_t* frameBuffer);
